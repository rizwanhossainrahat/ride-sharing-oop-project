...
amar_ride=Ride_Sharing('amar ride')
rahat=Rider('rahat','rahat@gmail.com',1234,'banasree',800)
amar_ride.add_rider(rahat)

fahad=Driver('fahad','fahad@gmail.com',5678,'rampura')

amar_ride.add_driver(fahad)

print(amar_ride)

rahat.request_ride(amar_ride,'sydabad')
rahat.show_current_ride()